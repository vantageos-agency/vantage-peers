...
3. Call `mcp__vantage-peers__search_memories_by_semantic` query={parsed}, namespace={determined}, limit=5
...
- User says "what did pi decide" or "tau's notes" -> namespace="orchestrator/{agent}"
