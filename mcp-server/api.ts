...
export type PublicApiType = {
  ...
  diary: {
    ...
    get: FunctionReference<
      "query",
      "public",
      { date: string; orchestrator: string },
      {
        _creationTime: number;
        _id: Id<"diary">;
        blockers?: Array<string>;
    ...
    list: FunctionReference<
      "query",
      "public",
      { limit?: number; orchestrator?: string },
      Array<{
        _creationTime: number;
        _id: Id<"diary">;
        blockers?: Array<string>;
    ...
    >;
    listByDateRange: FunctionReference<
      "query",
      "public",
      { from: string; orchestrator?: string; to: string },
      Array<{
        _creationTime: number;
        _id: Id<"diary">;
        blockers?: Array<string>;
  ...
  episodes: {
    storeEpisode: FunctionReference<
      "mutation",
      "public",
      {
        action: string;
      ...
      Id<"memories">
    >;
    listEpisodes: FunctionReference<
      "query",
      "public",
      {
        limit?: number;
    ...
    >;
    getCriticalInsights: FunctionReference<
      "query",
      "public",
      { limit?: number },
      Array<{
  ...
  mandates: {
    ...
    accept: FunctionReference<
      "mutation",
      "public",
      { callerOrchestrator: string; mandateId: Id<"mandates"> },
      null
    >;
    update: FunctionReference<
      "mutation",
    ...
    >;
    validateSpending: FunctionReference<
      "query",
      "public",
      { mandateId: Id<"mandates">; proposedAmount: number },
      {
        currentSpend: number;
  ...
  memories: {
    ...
    >;
    softDeleteMemory: FunctionReference<
      "mutation",
      "public",
      { memoryId: Id<"memories"> },
      null
  ...
  messages: {
    sendMessage: FunctionReference<
      ...
      Id<"messages">
    >;
    checkNewMessages: FunctionReference<
      "query",
      "public",
      { recipient: string; recipientInstanceId?: string; tenantId?: string },
      Array<{
        channel?: string;
        content: string;
        createdAt: number;
    ...
    deleteMessage: FunctionReference<
      "mutation",
      "public",
      { callerOrchestrator?: string; messageId: Id<"messages"> },
      { deleted: boolean; receiptsDeleted: number }
    >;
    listMessages: FunctionReference<
      "query",
      "public",
      { from?: string; limit?: number; sessionDay?: number },
      Array<{
        _creationTime: number;
        _id: Id<"messages">;
        channel?: string;
    ...
    >;
    listByChannel: FunctionReference<
      "query",
      "public",
  ...
  missions: {
    ...
    updateProgress: FunctionReference<
      "mutation",
      "public",
      { missionId: Id<"missions">; progress: number },
      null
    >;
  };
  profiles: {
    getProfile: FunctionReference<
      "query",
      "public",
      { instanceId?: string; orchestratorId?: string },
      {
        _creationTime: number;
        _id: Id<"profiles">;
        dynamic: {
    ...
    upsertProfile: FunctionReference<
      ...
      Id<"profiles">
    >;
    updateDynamic: FunctionReference<
      "mutation",
      "public",
      {
        currentTask?: string;
      ...
      null
    >;
    getProfileWithMemories: FunctionReference<
      "query",
      "public",
      {
        instanceId?: string;
    ...
    >;
    listProfiles: FunctionReference<
      "query",
      "public",
      { orchestratorId?: string },
      Array<{
  ...
  recurringTasks: {
    ...
    list: FunctionReference<
      "query",
      "public",
      { active?: boolean; assignedTo?: string; limit?: number },
      any
    >;
    update: FunctionReference<
      "mutation",
  ...
  search: {
    ...
    >;
    searchFixPatterns: FunctionReference<
      "action",
      "public",
      { limit?: number; query: string; scoreThreshold?: number },
      Array<{
        patternId: string;
        rootCause: string;
        score: number;
  ...
  tasks: {
    ...
    start: FunctionReference<
      "mutation",
      "public",
      { callerOrchestrator?: string; taskId: Id<"tasks"> },
      null
    >;
    ...
    deleteTask: FunctionReference<
      ...
      { deleted: boolean }
    >;
    listByMission: FunctionReference<
      "query",
      "public",
      {
        limit?: number;
    ...
    >;
    listOverdue: FunctionReference<
      "query",
      "public",
      { assignedTo?: string; limit?: number },
      any
    >;
  };
  dashboard: {
    ...
    >;
    getProjectSummary: FunctionReference<
      "query",
      "public",
      Record<string, never>,
      Array<{
  ...
  errorMonitor: {
    addDeployment: FunctionReference<
      "mutation",
      "public",
      {
    ...
    >;
    removeDeployment: FunctionReference<
      "mutation",
      "public",
      { name: string },
      null
    >;
    listDeployments: FunctionReference<
      "query",
      "public",
      Record<string, never>,
      Array<{
    ...
    listErrors: FunctionReference<
      "query",
      "public",
      { deployment?: string; limit?: number },
      Array<{
        _creationTime: number;
        _id: Id<"errorLogs">;
        count: number;
  ...
  fixPatterns: {
    ...
    validate: FunctionReference<
      "mutation",
      "public",
      { patternId: Id<"fixPatterns">; validatedFix: string },
      null
    >;
    linkIssue: FunctionReference<
      "mutation",
      "public",
      { issueId: string; patternId: Id<"fixPatterns"> },
      null
    >;
    get: FunctionReference<
      "query",
    ...
    listByProject: FunctionReference<
      "query",
      "public",
      { limit?: number; sourceProject: string },
      Array<{
        _creationTime: number;
        _id: Id<"fixPatterns">;
        createdAt: number;
    ...
    >;
    listByStack: FunctionReference<
      "query",
      "public",
      { limit?: number; stack: string },
      Array<{
        _creationTime: number;
        _id: Id<"fixPatterns">;
        createdAt: number;
  ...
  githubRepoMapping: {
    getByRepo: FunctionReference<"query", "public", { repo: string }, any>;
    list: FunctionReference<"query", "public", Record<string, never>, any>;
    add: FunctionReference<
      "mutation",
      "public",
      { active?: boolean; orchestrator: string; project: string; repo: string },
      any
    >;
    remove: FunctionReference<"mutation", "public", { repo: string }, any>;
  ...
  issues: {
    upsertFromGitHub: FunctionReference<
      "mutation",
      "public",
      {
        body: string;
    ...
    updateStatus: FunctionReference<
      ...
      any
    >;
    linkCommit: FunctionReference<
      "mutation",
      "public",
      { commitSha: string; fixedBy: string; issueNumber: number; repo: string },
      any
    >;
    linkTask: FunctionReference<
      "mutation",
      "public",
      { issueNumber: number; repo: string; taskId: string },
      any
    >;
    verify: FunctionReference<
      "mutation",
      "public",
      { issueNumber: number; repo: string; verifiedBy: string },
      any
    >;
    close: FunctionReference<
      ...
      any
    >;
    getByRepoNumber: FunctionReference<
      "query",
      "public",
      { issueNumber: number; repo: string },
      any
    ...
    listByProject: FunctionReference<
      ...
      any
    >;
    listByOrchestrator: FunctionReference<
      "query",
      "public",
      {
    ...
    listByStatus: FunctionReference<
      ...
      Array<any>
    >;
    getStats: FunctionReference<"query", "public", { project?: string }, any>;
    createExternal: FunctionReference<
      "mutation",
      "public",
      {
        assignedOrchestrator: string;
      ...
      Id<"issues">
    >;
    updatePrStatus: FunctionReference<
      "mutation",
      "public",
      {
        issueNumber: number;
      ...
      null
    >;
    listExternalOpen: FunctionReference<
      "query",
      "public",
      { limit?: number; prStatus?: "draft" | "open" | "merged" | "closed" },
      Array<{
        _creationTime: number;
        _id: Id<"issues">;
        assignedOrchestrator: string;
