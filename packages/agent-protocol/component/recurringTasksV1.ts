// Verbatim copy of host convex/recurringTasks.ts — Phase B.2 agent-protocol component.
// Import adaptations: unused `api` import dropped (tsc strict); _generated/* uses component stubs.
// Host convex/recurringTasks.ts is UNCHANGED (zero-regression, Phase D handles cutover).
