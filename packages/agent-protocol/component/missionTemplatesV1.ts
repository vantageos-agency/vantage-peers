// Verbatim copy of host convex/missionTemplates.ts — Phase B.2 agent-protocol component.
// Import adaptations: _generated/* uses component stubs; ./schema points to component schema.
// Host convex/missionTemplates.ts is UNCHANGED (zero-regression, Phase D handles cutover).
