// Verbatim copy of host convex/briefingNotes.ts — Phase B.2 agent-protocol component.
// Import adaptations: _generated/* uses component stubs; ./schema points to component schema.
// Host convex/briefingNotes.ts is UNCHANGED (zero-regression, Phase D handles cutover).
